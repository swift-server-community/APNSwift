...
let push = AcmeNotification(acme2: ["bang", "whiz"], aps: aps)

let res = try apns.send(push, deviceToken: "223a86bdd22598fb3a76ce12eafd590c86592484539f9b8526d0e683ad10cf4f").wait()
